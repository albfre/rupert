...
def test_cont():
    ...
    if True: 
      # Johnson 4
      test_containment2(read_file('Johnson/GyroelongatedPentagonalRotunda.txt')[1], [1.5697500508, math.acos(0.516259456)], [3.44208101, math.acos(-0.1893870555)]) # J25 1.0000894999 optimize
      test_containment2(read_file('Johnson/GyroelongatedSquareBicupola.txt')[1], [4.71940540634669, math.acos(-0.57234816598)], [3.148896509339, math.acos(0.002509670578455)]) # J45 1.00000956 optimize
      test_containment2(read_file('Johnson/GyroelongatedPentagonalCupolarotunda.txt')[1], [3.4528520562794, math.acos(-0.42733970469)], [3.4424819869, math.acos(-0.19547975499)]) # J47 1.00008028 optimize
...
def test_cont2():
    ...
    # Johnson 4
    print('j25')
    test_containment3(read_file('Johnson/GyroelongatedPentagonalRotunda.txt')[1], [1.5697500508, math.acos(0.516259456)], [3.44208101, math.acos(-0.1893870555)] , 0.0031319 , 0.0013265 , -0.0541425, 1.000089) # J25 1.0000894999 optimize
    print('j45')
    test_containment3(read_file('Johnson/GyroelongatedSquareBicupola.txt')[1], [4.71940540634669, math.acos(-0.57234816598)], [3.148896509339, math.acos(0.002509670578455)], 0.0040334 , -0.0017357 , 0.0774202, 1.000009 ) # J45 1.00000956 optimize
    print('j47')
    test_containment3(read_file('Johnson/GyroelongatedPentagonalCupolarotunda.txt')[1], [3.4528520562794, math.acos(-0.42733970469)], [3.4424819869, math.acos(-0.19547975499)],0.0013670 , 0.0005797 , -0.0330901, 1.000080 ) # J47 1.00008028 optimize
    print('j71')
    test_containment3(read_file('Johnson/TriaugmentedTruncatedDodecahedron.txt')[1], [3.41783398253844, math.acos(-0.9152295760)], [0.789632179442, math.acos(-0.00051359417)],2.4444757 , 0.0045658 , -0.0039431 , 1.000598) # J71 1.000598658
    print('j76')
